...
In this part we determine the first spot in the 3x3 section. This is the starting point of a double for loop in which we check if any of the numbers in the section is equal to our input. If not we can safely return true :)  | ```python
